% flapping_fun
% Input:
%   inputFile that contains an array of variables x (1x1445 doubles)
%   0 to omit plotting (faster), or 1 to plot figures
% Output:
%   output_file that contains function values (drag, power and lift), a 1x3 array of doubles

function[g] = flapping_fun(x_filename, plot_decide_string)
...
[connectivity,connectivity.error] = create_cell(x, Gvars, input); % create connectivity
