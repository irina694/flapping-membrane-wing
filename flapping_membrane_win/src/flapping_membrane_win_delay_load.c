 ...
 */
FARPROC WINAPI flapping_membrane_winDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = flapping_membrane_winDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = flapping_membrane_winDelayLoadWin32FailureHook;
#endif
